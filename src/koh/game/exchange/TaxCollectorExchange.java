...
/**
 * Created by Melancholia on 2/11/17.
 */
public class TaxCollectorExchange extends Exchange {

    private final WorldClient myClient;
    private final TaxCollector taxer;

    public TaxCollectorExchange(WorldClient Client, TaxCollector taxer1) {
