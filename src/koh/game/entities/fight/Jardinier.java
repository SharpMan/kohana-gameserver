 ...
 * 7,Planter une Cawotte à chaque fois que le sort est disponible, pendant toute la durée du combat.
 */
public class Jardinier extends Challenge {

    public static final int SPELL = 367;
    public Jardinier(Fight fight, FightTeam team) {
        super(fight, team);
    }
