 ...
 * 14,Lancer le sort Roulette à chaque fois que le sort est disponible, pendant toute la durée du combat.]
 */
public class RoyalCasino extends Challenge {

    public static final int SPELL = 101;
    public RoyalCasino(Fight fight, FightTeam team) {
        super(fight, team);
    }
