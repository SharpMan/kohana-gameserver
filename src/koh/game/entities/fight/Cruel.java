 ...
 * 10,Les adversaires doivent être achevés dans l'ordre croissant de leur niveau.
 */
public class Cruel extends Challenge {

    public Cruel(Fight fight, FightTeam team) {
        super(fight, team);
    }
