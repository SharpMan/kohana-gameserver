 ...
 * 28,Les personnages de sexe masculin doivent laisser les personnages de sexe féminin achever les adversaires pendant toute la durée du combat.
 */
public class NoSoumise extends Challenge {

    public NoSoumise(Fight fight, FightTeam team) {
        super(fight, team);
    }
