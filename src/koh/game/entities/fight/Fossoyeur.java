 ...
 * 12,Invoquer un Chaferfu à chaque fois que le sort est disponible, pendant toute la durée du combat.]
 */
public class Fossoyeur extends Challenge {
    public static final int SPELL = 373;

    public Fossoyeur(Fight fight, FightTeam team) {
        super(fight, team);
    }
