 ...
 * 9,Occasionner des dommages ou soigner avec une arme sur alliés ou ennemis, à chaque tour de jeu.
 * TODO check targets who know if the players care x0
 */
public class Barbare extends Challenge {
    public Barbare(Fight fight, FightTeam team) {
        super(fight, team);
    }

    private boolean weaponCasted;
