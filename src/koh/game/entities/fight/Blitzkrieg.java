 ...
 * 38,ès qu'un adversaire est attaqué, il doit être achevé avant le début de son tour de jeu.
 */
public class Blitzkrieg extends Challenge {

    public Blitzkrieg(Fight fight, FightTeam team) {
        super(fight, team);
    }
    ...
    public void onTurnStart(Fighter fighter) {
        if(fighter == target && !target.isAlive()){
            this.failChallenge();
        }
    }
