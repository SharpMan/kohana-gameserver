...
public class ActionHandler {
    ...
    public static void HandleGameActionAcknowledgementMessage(WorldClient Client, GameActionAcknowledgementMessage Message) {
        if (Client.getCharacter().getFight() == null || Client.getCharacter().getFighter() != null || Client.getCharacter().getFighter() != Client.getCharacter().getFight().getCurrentFighter()) {
            return;
        }
